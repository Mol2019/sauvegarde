@extends('app.layouts.base',["title" => "Gestion des services"])
                                ...
                                <tbody>
                                    @foreach($data as $service)
                                        <tr>
                                            <td>{{ $service->name }}</td>
                                            <td>
                                                <button id="{{ $service->id }}" class="btn btn-info edit_id service_id" data-toggle="modal" data-target="#edit">Modifier</button>
                                                <button id="{{ $service->id  }}" class="btn btn-danger delete_id" data-toggle="modal" data-target="#delete">Supprimer</button>
                                            </td>
                                        </tr>
                                    @endforeach
                                </tbody>
...
@section('form-modal')
    <form action="{{ route('service.create') }}" method="post" id="add-form">
        <div class="modal-header flex-column text-center bg-primary">
